            ...
            if x == 0:
                ...
                lines.extend(
                    (
                        ...
                        f"*Order filled at:* {order['order_filled_date']}",
                        f"({days}d {hours}h {minutes}m {seconds}s from previous entry)",
                    )
                )
